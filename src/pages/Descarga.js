...
const Descarga = ({ language, setLanguage }) => {
  ...
  return (
    <div>
      ...
      <div className="max-w-[1200px] mx-auto flex flex-col items-center justify-center mt-32">
        <h4 className="font-[gotham-body] text-4xl mb-8">
        ...
        <img
          ...
          className="w-[200px] xl:w-[200px] mb-12"
          alt="qr-code"
        />
